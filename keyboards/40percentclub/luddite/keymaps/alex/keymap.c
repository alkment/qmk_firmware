...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT_60_ansi(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                                      KC_LALT, KC_RGUI, KC_RCTL, MO(_FL)
  ),
  ...
  [_FL] = LAYOUT_60_ansi(
    ...
    KC_GRV, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, KC_PSCR, KC_SLCK, KC_PAUS, _______,
